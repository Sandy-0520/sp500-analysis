...
Original file is located at
    https://es.wikipedia.org/wiki/Anexo:Compa%C3%B1%C3%ADas_del_S%26P_500
"""
...
def load_data(df, ticker):
    try:
        filename = os.path.join(data_dir, f'sandy_processed.csv')
